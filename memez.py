...
def save_chat_history(user_id: str, question: str, answer: str):
    ...
    with sqlite3.connect("credits.db") as conn:
        ...
        c.execute(
            ...
            (user_id, question, answer, "2025-06-11 15:18:56"),
        )
        conn.commit()
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                response = await client.get(
                    "https://virtusim.com/api/json.php",
                    params=params,
                    timeout=30.0
                )
                ...
                if response.status_code == 200:
                    try:
                        ...
                        for service_item in raw_services_list:
                            try:
                                stock = int(service_item.get("tersedia", 0))  # Changed from "stock" to "tersedia"
                                if stock > 0:
...
async def get_virtusim_services(country: str = Query("Indonesia"), service: str = Query("Whatsapp")):
    ...
    try:
        ...
        logger.info(f"Timestamp: 2025-06-11 15:18:56")
        ...
        logger.error(f"Timestamp: 2025-06-11 15:18:56")
