...
def chat_with_AI(message, history, model_select, mode_dropdown, session_id, user_name_state, image=None, language="Indonesia", mood="Biasa"):
    user_id = session_id
    if not user_id:
...
def send_and_clear(message, history, model_select, mode_dropdown, session_id, user_name_state, image=None, language="Indonesia", mood="Biasa"):
    updated_history, state_data = chat_with_AI(message, history, model_select, mode_dropdown, session_id, user_name_state, image, language, mood)
...
def handle_google_callback(code, state, oauth_state):
        ...
        with gr.Tabs() as tabs:
            with gr.TabItem("Welcome", id=0) as welcome_tab:
                ...
                def start_google_login():
                    ...
                    return authorization_url, state, "Initiating Google Login... (Redirecting)"

                login_google_btn.click(
                    fn=start_google_login,
                    inputs=None,
                    outputs=[gr.State(), oauth_state, welcome_message],
                ...
                callback_btn.click(
                    ...
                    inputs=[code_input, state_input, oauth_state],
                    outputs=[user_id_state, user_name_state, welcome_message]
                )
            ...
            with gr.TabItem("Chat", id=1) as chat_tab:
                ...
                send_btn.click(
                    fn=send_and_clear,
                    inputs=[textbox, chatbot, model_dropdown, mode_dropdown, user_id_state, user_name_state, image_upload, language_state, mood_state],
                ...
                def handle_audio(audio_path, current_history, model_select, mode_dropdown, user_id, user_name_state, language, mood):
                ...
                audio_input.change(
                    fn=handle_audio,
                    inputs=[audio_input, chatbot, model_dropdown, mode_dropdown, user_id_state, user_name_state, language_state, mood_state],
