...
def ensure_db_and_log():
    ...
    try:
        ...
        with sqlite3.connect(DB_PATH) as conn:
            ...
            admin_users = [
                ("admin@kugy.ai", "Admin", 999999, 0, "2025-06-11 17:45:49", 0, ""),
                ("testadmin", "Test Admin", 999999, 0, "2025-06-11 17:45:49", 0, "")
            ]
...
def add_or_init_user(user_id: str, user_name: str = "User"):
    ...
    try:
        with sqlite3.connect(DB_PATH) as conn:
            ...
            conn.commit()
            logger.info(f"User initialized/updated: {user_id}")
    except Exception as e:
    ...
    try:
        with sqlite3.connect(DB_PATH) as conn:
            ...
            c.execute(
                ...
                (user_id, question, answer, "2025-06-11 17:45:49"),
            )
            conn.commit()
