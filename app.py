...
logger.info(f"STABILITY_API_KEY: {'Set' if API_KEYS['stability'] else 'Not set'}")
logger.info(f"OPENROUTER_API_KEY: {'Set' if API_KEYS['openrouter'] else 'Not set'}")
    ...
    with gr.Blocks(
        ...
        with gr.Tabs() as tabs:
            ...
            with gr.Tab("Debug", id="Debug"):
                ...
                def get_debug_info():
                    debug_info = (
                        f"STABILITY_API_KEY: {'Set' if API_KEYS['stability'] else 'Not set'}\n"
                        f"OPENROUTER_API_KEY: {'Set' if API_KEYS['openrouter'] else 'Not set'}\n"
