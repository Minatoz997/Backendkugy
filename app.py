...
def oauth_callback():
    ...
    return redirect(f"https://backend-cb98.onrender.com/?code={code}&state={state}")
...
# Integrate Gradio into Flask
gradio_app = create_gradio_interface()

@app.route('/', methods=['GET', 'POST'])
def gradio_endpoint():
    return Response(gradio_app.handle_request(request), mimetype='text/html')
