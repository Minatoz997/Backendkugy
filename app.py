...
def create_gradio_interface():
    with gr.Blocks(
            ...
            with gr.Tab("Welcome", id="Welcome") as welcome_tab:
                ...
                def start_guest_mode(chat_history_state):
                    try:
                        ...
                        conn.commit()
                        conn.close()
                        return guest_id, chat_history_state, f"Guest Mode ({guest_id}) active! You have 25 free credits.", gr.update(selected="Chat"), True, False, ""
                    except Exception as e:
                ...
                guest_button.click(
                    fn=start_guest_mode,
                    inputs=[chat_state],
                    outputs=[user_id_state, chat_state, welcome_message, tabs, welcome_box, success_msg, user_badge]
                )

                callback_btn.click(
                    fn=handle_google_callback,
                    inputs=[code_input, state_input],
                    outputs=[user_id_state, user_name_state, welcome_message, tabs, welcome_box, success_msg, user_badge]
                )
        ...
        def check_initial_login(user_id_state, user_name_state, chat_history_state):
            try:
                ...
                if user_id:
                    ...
                    # Hide welcome_box, show success_msg, update badge
        ...
        demo.load(
            ...
            outputs=[user_id_state, user_name_state, chat_state, welcome_message, tabs, welcome_box, success_msg, user_badge]
        )
    return demo
