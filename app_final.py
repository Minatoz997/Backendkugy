...
app.add_middleware(
    ...
    same_site="lax",  # Ubah dari "none" ke "lax" untuk kompatibilitas yang lebih baik
    https_only=False,  # Set ke False untuk development, True untuk production
)
    ...
    async def _call_agent(self, agent_name: str, messages: List[Dict[str, str]]) -> str:
        ...
        try:
            ...
            headers = {
                ...
                "HTTP-Referer": "https://backend-cb98.onrender.com",
