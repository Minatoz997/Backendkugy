...
def save_chat_history(user_id: str, question: str, answer: str):
    ...
    with sqlite3.connect("credits.db") as conn:
        ...
        c.execute(
            ...
            (user_id, question, answer, "2025-06-11 15:48:46"),
        )
        conn.commit()
...
class VirtuSimService:
    def __init__(self):
        ...
        self.base_url = "https://virtusim.com/api/v2/json.php"  # Changed to v2 API
...
async def get_virtusim_services(country: str = Query("Indonesia"), service: str = Query("Whatsapp")):
    ...
    try:
        ...
        logger.info(f"Timestamp: 2025-06-11 15:48:46")
        ...
        return JSONResponse(result)  # Return raw result from service
    except Exception as e:
        logger.error(f"=== VIRTUSIM SERVICE REQUEST ERROR ===")
        logger.error(f"Error: {str(e)}")
        logger.error(f"Timestamp: 2025-06-11 15:48:46")
