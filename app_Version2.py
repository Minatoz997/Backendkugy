...
# Endpoint root untuk Render health check
@app.get("/")
async def root():
    ...
    with gr.Blocks(
        ...
        with gr.Tabs() as tabs:
            with gr.Tab("Welcome", id="Welcome") as welcome_tab:
                ...
                with gr.Row():
                    gr.HTML('<a href="https://accounts.google.com/o/oauth2/v2/auth?client_id=385259735074-ui76jtbrq23idr9bk86gpbmpe06691nt.apps.googleusercontent.com&redirect_uri=https://backend-cb98.onrender.com/auth/callback&response_type=code&scope=profile email&state=xyz&access_type=offline" class="oauth-link">🔗 Login with Google</a>')
